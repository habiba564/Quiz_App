const questions = [
    { question: 'mango ', options: ['fruits', 'vegetables'], correctAnswer: 'fruits' },
    ...
    function showQuestion() {
        ...
        optionsContainer.innerHTML = ''; // empty options before updating the current question
    ...
    function checkAnswer(userAnswer, correctAnswer) {
        ...
        // correct or wrong sign in the feedback bar
        ...
        if (currentQuestionIndex < questions.length) {
            setTimeout(() => {
                resetOptions();
                showQuestion();
                // empty feedback bar for the next question
    ...
    function showHistory() {
        ...
        // orderd and display user history from local storage
        const userHistory = JSON.parse(localStorage.getItem('userHistory')) || [];
